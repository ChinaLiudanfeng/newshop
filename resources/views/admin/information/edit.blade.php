...
@section('content')
    ...
    <a href="{{ url('admin/information/index') }}" class="layui-btn layui-btn-primary layui-btn-sm">返回</a>
    <hr>
        ...
        <div class="layui-form-item" style="width: 400px;">
            ...
            <div class="layui-input-block">
                <input type="text" name="infor_title" required lay-verify="required" placeholder="请输入话题名称"
                       ...
                       @if($infor)
                       value="{{ $infor->infor_title }}"
                        @endif
                >
                @if($infor)
                    <input type="hidden" name="id" value="{{ $infor->infor_id }}" id="infor_id">
                @endif
            </div>
        </div>
        <div>
            ...
            <div  class="layui-input-block">
                <textarea  name="infor_content" id="goods_intro" style="width: 600px;height: 50">
                    @if($infor)
                        {{ $infor->infor_content }}
                    @endif
                </textarea>
        ...
        layui.use('layedit', function(){
            ...
            form.on('submit(formDemo)', function (data) {
                ...
                $.ajax({
                    ...
                    type:"POST",
                    data:{infor_id:infor_id,infor_title : infor_title, infor_content : infor_content },
                    dataType:"json",
