...
@section('content')
    <a href="{{ route('admin.Information_create.create') }}" class="layui-btn">添加资讯</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;">
                    <a href="{{ route('admin.Information_edit.edit') }}?infor_id={{ $infor['infor_id'] }}"
        ...
        function del(infor_id) {
            layer.confirm('你确定要删除这个资讯吗？', {
                ...
                btn: ['确定', '取消'] //按钮
                    ...
                    $.post("{{ route('admin.Information_delete.delete') }}", {infor_id: infor_id},
                        function (data) {
                            if (data.code === 0) {
                                layer.msg('操作成功', {
                                    offset: '15px'
