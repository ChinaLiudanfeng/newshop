...
@section('content')
    ...
    <script type="text/javascript">
         ...
         var url ="{{url('admin/lect/index_list')}}";
        $.ajax({
            url:url,
            type:"GET",
            dataType:"json",
        ...
        $(document).on('click','.btn',function(){
            var id = $(this).attr('id');
            location.href="http://www.amshop.com/admin/lect/edit?id="+id;
        });

         //修改
         $(document).on('click','.lest',function(){
             var id = $(this).attr('id');
//             alert(id);
             location.href="http://www.amshop.com/admin/lect/course?id="+id;
         });
        ...
        function post(res){
            ...
            $.each(res.data,function(i,v){
                ...
                tr.append("<td><a href='javascript:;' id='"+v.lect_id+"'class='del layui-btn layui-btn-sm layui-btn-danger'>删除</a>&nbsp;<a href='javascript:;' id='"+v.lect_id+"' class='btn layui-btn layui-btn-sm'>编辑</a>&nbsp;<a href='/kao/index' class='layui-btn layui-btn-sm'>添加</a>&nbsp;<a href='javascript:;' id='"+v.lect_id+"' class=' lest layui-btn  layui-btn-sm'>讲师课程</a></td>");
